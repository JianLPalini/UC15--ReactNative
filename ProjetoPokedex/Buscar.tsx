...
import ListaPokemon from './ListadePokemon'
...
const Buscar = () => {
  ...
  const [encontrados, setEncontrados] = useState(dadosPokemon)

  const handleBuscar = () => {
    const resultado = dadosPokemon.filter((item) =>
  ...
  return (
    <ScrollView>
      ...
      <ListaPokemon pokemons={encontrados} />
    </View>
    </ScrollView>
  )
}
